...
export function BlogIndex({ posts, categories, authors }: BlogIndexProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 min-[900px]:grid-cols-[220px_1fr] min-[900px]:gap-12">
      ...
      <aside className="hidden min-[900px]:block min-[900px]:sticky min-[900px]:top-24 min-[900px]:self-start min-[900px]:max-h-[calc(100vh-7.5rem)] min-[900px]:overflow-y-auto">
